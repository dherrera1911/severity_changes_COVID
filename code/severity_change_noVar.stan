...
parameters {
  ...
  vector interceptChange;        // intercept change of each location 
...
transformed parameters{
  ...
  outcomeRate2 = inv_logit(locationIntercept[location] + interceptChange + ageSlope * ageVec);  // logistic regression model 
